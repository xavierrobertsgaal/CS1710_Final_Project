class ElectricityMap2 {
    ...
    processData(csvData) {
        ...
        csvData.forEach(row => {
            ...
            if (state !== 'US') {
                ...
                if (!processed[state][sector]) {
                    processed[state][sector] = {};
                }
    ...
    initMap() {
        ...
        // Load GeoJSON data and create the choropleth layer
                    ...
                    onEachFeature: (feature, layer) => {
                        layer.on({
                            ...
                            click: (e) => {
                                ...
                                L.popup()
                                    .setLatLng(e.latlng)
                                    .setContent(`<b>${stateName}</b><br>${this.currentSector}: ${d3.format(",")(value)} BTU`)
                                    .openOn(vis.map);
                            }
                        });
                    }
    ...
    initLegend() {
        ...
        this.legendMin = legend.append('div')
            .style('float', 'left')
            .text('0 BTU');

        this.legendMax = legend.append('div')
            .style('float', 'right')
            .text('Max BTU');
    }
